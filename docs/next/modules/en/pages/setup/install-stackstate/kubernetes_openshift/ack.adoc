...
Please create a separate file for the ACK-specific values and use it during installation. For example, if you follow https://docs.stackstate.com/self-hosted-setup/install-stackstate/kubernetes_openshift/kubernetes_install#_deploy_suse_observability_with_helm[Kubernetes install documentation] and save the above values in a file called `ack-values.yaml`, you can install Suse Observability with:
