...
When the ldap password should come from an external secret, follow link:/setup/security/external-secrets.adoc#getting-authentication-data-from-an-external-secret[these steps] but fill in the following data:
