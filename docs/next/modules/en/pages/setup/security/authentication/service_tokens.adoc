...
When the bootstrap token should come from an external secret, follow link:/setup/security/external-secrets.adoc#getting-authentication-data-from-an-external-secret[these steps] and add the following data:
