...
If a newer StackPack version does not behave as expected, you can downgrade to an older version with the xref:/setup/cli/cli-sts.adoc[SUSE Observability CLI (`sts`)].
