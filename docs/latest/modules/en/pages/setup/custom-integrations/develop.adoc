...
- The `package` subcommand packages, uploads, and installs your StackPack with a test version suffix.
...
. xref:/stackpacks/about-stackpacks.adoc#_install_or_uninstall_a_stackpack[Install or Upgrade your StackPack] via the {stackstate-product-docs} stackpacks UI.
