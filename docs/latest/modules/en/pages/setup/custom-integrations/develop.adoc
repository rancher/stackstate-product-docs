...
[TIP]
====
Use this approach in your CI/CD pipeline to validate StackPacks before publishing them. It ensures your StackPack meets all requirements without needing a running {stackstate-product-name} instance.
====
