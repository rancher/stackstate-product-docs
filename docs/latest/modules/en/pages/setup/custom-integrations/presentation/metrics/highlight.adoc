...
Note that only overrides from the same section are taken into account.  If a different section reuses the same metric, overriding some fields, those are merged separately.
