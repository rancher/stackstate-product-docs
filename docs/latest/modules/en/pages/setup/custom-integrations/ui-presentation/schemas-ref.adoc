...
Related resources are sections on a component's highlight page that show other components related to the one being viewed (e.g., "This service instance has 5 related pods").  Each section renders as an overview table.
