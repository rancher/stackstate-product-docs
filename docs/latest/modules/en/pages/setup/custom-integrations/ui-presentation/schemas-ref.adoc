...
|external.mappingName            | string              | The name of the component mapping
|external.mappingIdentifier      | string              | The identifier of the component mapping
|external.additionalIdentifiers  | string              | Additional identifiers contributed by the external component
