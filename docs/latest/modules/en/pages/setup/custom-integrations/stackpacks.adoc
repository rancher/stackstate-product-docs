...
`stackpack.yaml`:: The StackPack manifest. It defines metadata such as `schemaVersion`, `version`, `name`, `displayName`, `version`, categories, logo, lifecycle text resources, and companion StackPacks.
