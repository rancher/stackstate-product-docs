...
The monitor can be implemented using the guide at xref:/setup/custom-integrations/monitors/index.adoc[Add a threshold monitor to components using the CLI]
