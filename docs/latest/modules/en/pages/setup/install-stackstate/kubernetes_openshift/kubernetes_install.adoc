...
[IMPORTANT]
=====
Although you can still specify a legacy API key for the `receiverApiKey` variable, you are recommended to use bootstrap service tokens. For more information on how to set up a bootstrap service token, see xref:/use/security/k8s-service-tokens.adoc#_set_up_a_bootstrap_service_token[Set up a bootstrap service token].
=====
