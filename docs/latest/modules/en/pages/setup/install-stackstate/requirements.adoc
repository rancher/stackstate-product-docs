...
The `Minimum Node Size` and `Minimum Node Count` refer to the minimum size and amount of nodes required to install the platform and is unrelated to the `Default Node Size` used to measure the size of the environment under observation.
====
