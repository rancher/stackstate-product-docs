...
. If the issue might be performance related, also run xref:/setup/install-stackstate/support-package-performance.adoc[Support Package (Performance)] to actively investigate performance.
