...
Alternatively, go to the *CLI* page in the {stackstate-product-name} UI and copy the *Quick installation* command for *Windows* - this is pre-filled with the correct `<URL>` and `<API-TOKEN>` for your {stackstate-product-name} instance.
...
Alternatively, go to the *CLI* page in the {stackstate-product-name} UI and copy the *Quick installation* command for *macOS* - this is pre-filled with the correct `<URL>` and `<API-TOKEN>` for your {stackstate-product-name} instance and will install the CLI at the default location.
...
Alternatively, go to the *CLI* page in the {stackstate-product-name} UI and copy the *Quick installation* command for *Linux* - this is pre-filled with the correct `<URL>` and `<API-TOKEN>` for your {stackstate-product-name} instance.
...
| context
| Manage {stackstate-product-name} contexts and configurations

| dashboard
| Manage, test and develop dashboards

| graph
| Manage the {stackstate-product-name} Graph
...
| script
| Run custom scripts against {stackstate-product-name}

| service-token
| Manage service tokens for authentication

| settings
| Manage {stackstate-product-name} settings and configurations

| stackpack
| Manage and upload StackPacks

| topic
| Manage {stackstate-product-name} Kafka topics

| topology-sync
| Manage topology synchronization

| user-session
| Inspect user session information
