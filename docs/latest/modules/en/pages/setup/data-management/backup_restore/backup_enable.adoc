...
[NOTE]
====
This page applies to {stackstate-product-name} 2.7.0 or newer. If you are upgrading from a version prior to 2.10.0, see xref:/setup/data-management/backup_restore/migration_to_s3proxy.adoc[Migrating to S3Proxy] for important information about changes in configuration of the backup and restore solution.
====
...
* xref:/setup/data-management/backup_restore/backup_enable.adoc#_aws_s3[AWS S3]
* xref:/setup/data-management/backup_restore/backup_enable.adoc#_azure_blob_storage[Azure Blob Storage]
* xref:/setup/data-management/backup_restore/backup_enable.adoc#_kubernetes_persistent_volume[Kubernetes storage]
