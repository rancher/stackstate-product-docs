...
[CAUTION]
====
*Restore functionality requires stopping all producers (like OpenTelemetry exporters). The script scales the workloads down before the backup, and up after the backup finished.*
====
