...
The backup schedules can be configured using the Helm values `victoria-metrics-0.backup.scheduled.hourly` and `victoria-metrics-0.backup.scheduled.daily` according https://github.com/aptible/supercronic/tree/master/cronexpr[cronexpr format]
