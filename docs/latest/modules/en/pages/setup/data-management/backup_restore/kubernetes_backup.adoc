...
[WARNING]
====
*This page describes the legacy backup approach using scripts. For {stackstate-product-name} vX.Y.Z or newer, use the new xref:/setup/data-management/backup_restore/backup_enable.adoc[backup CLI] instead.*
