...
See this page for xref:/setup/otel/getting-started/getting-started-lambda.adoc[guidance and instruction] on how to set up a batching collector that acts as a security proxy for SUSE Observability.
