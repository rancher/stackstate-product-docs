...
. Verify {stackstate-product-name} is receiving traces and/or metrics by searching for the metrics / traces in the metrics / trace explorer for your service name
...
== Metrics in {stackstate-product-name}
