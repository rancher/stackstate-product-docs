...
An `OtelRelationMapping` describes how a relationship between two components should be created from OpenTelemetry data.
...
Topology mappings rely heavily on the https://cel.dev/[Common Expression Language (CEL)] to select telemetry, extract values, and construct component and relation fields.
