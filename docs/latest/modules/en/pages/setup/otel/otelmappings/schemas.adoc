...
= Schemas for Topology Mappings
:revdate: 2025-12-23
:page-revdate: {revdate}
:description: Open Telemetry Mappings Schemas
...
* Component and relation identity, merging & lifecycle
* Input traversal model
* Variables
* Tag mappings
* CEL expression explanation
* Common patterns and best practices
* OTel mapping examples
...
This section provides complete OTel mapping examples to tie all this information together.

=== OtelComponentMapping example
...
- _type: "OtelComponentMapping"
  ...
  identifier: "urn:stackpack:open-telemetry-2:shared:otel-component-mapping:database"
  input:
    signal:
      - "METRICS"
    resource:
  ...
  output:
    identifier: "urn:opentelemetry:namespace/${vars.clientServiceNamespace}:service/${vars.client}:database/${vars.server}"
    name: "${vars.server}"
    typeName: "database"
    typeIdentifier: "urn:stackpack:open-telemetry:shared:component-type:database"
    layerName: "Databases"
    layerIdentifier: "urn:stackpack:common:layer:databases"
    domainName: "Open Telemetry"
    domainIdentifier: "urn:stackpack:open-telemetry:shared:domain:opentelemetry"
    required:
      tags:
...
- _type: "OtelRelationMapping"
  ...
  identifier: "urn:stackpack:open-telemetry-2:shared:otel-relation-mapping:database"
  input:
    signal:
      - "METRICS"
    resource:
  ...
  conditions:
    - expression: |
      ...
      action: "CREATE"
  output:
    sourceId: "urn:opentelemetry:namespace/${vars.clientServiceNamespace}:service/${vars.client}:serviceInstance/${vars.clientServiceInstanceId}"
    targetId: "${vars.targetId}"
    typeName: "database"
    typeIdentifier: "urn:stackpack:open-telemetry:shared:relation-type:database"
  expireAfter: 900000
----
