...
Install the operator using Application Collection image pull secret named `application-collection` (xref:https://docs.apps.rancher.io/get-started/authentication[Application Collection authentication guide]):
