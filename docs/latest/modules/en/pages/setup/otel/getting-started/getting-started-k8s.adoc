...
We install the collector with the Helm chart provided by the link:https://apps.rancher.io/applications/opentelemetry-collector[SUSE Application Collection]. Please check their link:https://docs.apps.rancher.io/get-started/authentication[authentication guide] to configure Application Collection OCI credentials in your Kubernetes cluster.
...
Install the collector using the configuration file and the Application Collection image pull secret named `application-collection` (link:https://docs.apps.rancher.io/get-started/authentication[Application Collection authentication guide]):
...
By default, the chart installs the link:https://github.com/open-telemetry/opentelemetry-collector-releases/blob/main/distributions/otelcol-k8s/README.md[OpenTelemetry Collector Kubernetes Distro], but other distributions are supported. To change the distribution you can override the image tag:
...
* link:https://docs.apps.rancher.io/reference-guides/opentelemetry-collector[Open Telemetry Collector reference guide from SUSE Application Collection]
