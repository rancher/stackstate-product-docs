...
* *Resource Override Precedence:* Resolved an issue introduced in version 2.8.0 where sizing profile defaults incorrectly took precedence over user-specified resource values. User-defined settings now correctly override defaults.
