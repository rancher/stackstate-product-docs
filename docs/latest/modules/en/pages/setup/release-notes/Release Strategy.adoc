= Release Strategy
:description: Learn about the release strategy for SUSE Observability Platform, Agents, and Rancher UI Extension, including update cadence, compatibility, and upgrade
