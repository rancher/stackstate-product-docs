...
* *Gateway API Support*: The SUSE Observability Helm chart now supports the Kubernetes Gateway API as an alternative to a standard Ingress. For details, see the xref:docs/latest/modules/en/pages/setup/install-stackstate/kubernetes_openshift/ingress.adoc[Ingress documentation].
