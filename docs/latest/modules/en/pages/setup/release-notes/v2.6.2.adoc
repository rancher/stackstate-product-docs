...
* This release contains 2 versions of the Open Telemetry stackpack using the same logo. Hover over the stackpack to see the name. When installing or upgrading, use the stackpack named "Open Telemetry" and do not install the "Open Telemetry 2.0" stackpack. The latter does not provide any functionality at the moment and will be removed in the next release.
