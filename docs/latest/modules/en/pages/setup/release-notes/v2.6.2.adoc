...
* This release contains 2 version of the Open Telemetry stackpack using the same logo. On-hover over the stackpack you can see the name. When installing or upgrading use the stackpack named "Open Telemetry" and don't install the "Open Telemetry 2.0" stackpack. The latter doesn't provide any functionality at the moment and will be removed in the next release.
