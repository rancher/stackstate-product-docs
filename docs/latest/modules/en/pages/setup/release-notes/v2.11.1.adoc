...
* *StackGraph v2 Backup & Restore (Experimental):* Introduced a new `stackgraph-v2` backup and restore system featuring incremental backups and significant performance improvements for both backup and restore operations.
