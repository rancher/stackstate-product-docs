...
:description: Check your target environments architecture before installing the SUSE Observability Agent, as it is designed and tested to run only on x86_64 (AMD64/Intel
