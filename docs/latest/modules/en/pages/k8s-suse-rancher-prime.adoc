...
The following table describes the resources required to deploy the SUSE Observability server in a cluster, given the amount of `default nodes` that will be observed and whether the installation should be HA or not.
