...
If you run into any problems during the installation of the UI extension for Observability, check the xref:/setup/install-stackstate/extension-troubleshooting.adoc[Extension troubleshooting guide].