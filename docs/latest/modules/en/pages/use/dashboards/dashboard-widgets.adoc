...
When viewing an individual component in SUSE Observability, you can add charts from that view directly to a dashboard by using the three-dot menu and selecting "Add to dashboard".
...
The resulting widget in the dashboard will have a link to the resource it was added from.
