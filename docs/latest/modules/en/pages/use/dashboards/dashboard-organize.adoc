...
image::dashboards/organize-widgets.png[Organize widgets on a dashboard]

== Edit or delete a widget

To edit or delete a widget, click the three dots icon in the top right of the widget. From here you can select **Edit widget** or **Delete widget**.
