...
To inspect the data of the widget in more detail, click the icon beside the "more actions" button in the metric inspector drawer.

image::dashboards/widget-organization.png[Editing, deleting and inspecting widgets]
