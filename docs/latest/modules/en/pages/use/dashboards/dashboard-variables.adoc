...
By configuring variables for a dashboard, you can create dashboards with widgets that are more dynamic. Variables enable the reuse of a single dashboard definition for different use-cases. 

== Viewing a dashboard's variables
...
To view all built-in variables, click the accordion entitled "SUSE Observability PromQL variables".

== Adding a new variable

To add a new variable, open the "Edit dashboard variables" drawer as above, then click the "Add variable" button. A second drawer will open where you can configure the new variable.
...
| Display label
| A friendly name for the variable that will be shown on the dashboard when <<selecting-variables,selecting the variable>>. This will help users identify the variable.

| Description
| A description to help users understand the purpose for the variable. This description is shown in the "Edit dashboard variables" drawer.
