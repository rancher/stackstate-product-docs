...
[%collapsible]
====
* *PromQL*: Specify the PromQL query to define the metric you want to monitor. For more information, see xref:/use/metrics/k8sts-explore-metrics#_promql_queries[PromQL queries].
+
[source, promql]
----
...
* *Component identifier*: Specify the unique identifier of the component to which this monitor will be mapped. This ensures that the monitor is correctly associated with the intended component within your Kubernetes environment. For more information, see xref:/configure/topology/identifiers.html[Identifiers].
====
+
.Remediation
[%collapsible]
