...
Metric charts are ordered on priority and name. Both are configured on the xref:/setup/custom-integrations/presentation/metrics/perspective.adoc[metric binding].
endif::[]
