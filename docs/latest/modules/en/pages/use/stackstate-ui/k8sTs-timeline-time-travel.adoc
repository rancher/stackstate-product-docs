...
* When a custom telemetry interval is set for the telemetry interval, {stackstate-product-name} pauses the <<topology-time,topology time>> and enter <<time-travel,time travel mode>>.
====
...
On the timeline, the selected topology time is indicated by the play head - a black line with the current topology time at the top. It is also specified in the *Topology time* box at the top of the timeline.
