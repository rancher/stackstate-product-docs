...
Links are navigation entries shown on the component highlight page. They can point to an internal {stackstate-product-name} URL or an external system such as a dashboard, runbook or management console.
