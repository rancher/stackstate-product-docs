...
AI Assistant helps you investigate issues in {stackstate-product-name} without leaving the product UI. It opens as a drawer and can use the context of your current view to answer questions, explain findings, and guide the next troubleshooting steps.
...
{stackstate-product-name} also provides an `AI Sessions` page where you can review existing sessions and reopen them in the drawer.
...
* do not share secrets, credentials, service tokens, personal data, or other confidential information in prompts
